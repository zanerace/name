export function Footer() {
  return (
    <footer className="pt-14 md:pt-20 pb-10 w-full max-w-full overflow-x-hidden">
      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 frame-panel p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-4 font-ui text-[15px] uppercase text-muted-foreground min-w-0">
